...
import eum.backed.server.config.security.JwtTokenProvider;
...
public class UsersService {
    ...
    public ResponseEntity<?> signIn(String email) {

        UsernamePasswordAuthenticationToken authenticationToken =customUserService.toAuthentication(email);
